package com.example.marketboard.util;

import com.example.marketboard.constant.ErrorMessage;
import com.example.marketboard.model.Account;
import com.example.marketboard.exception.InsufficientFundsException;
import com.example.marketboard.exception.InsufficientWithdrawException;
import com.example.marketboard.exception.InvalidOperationException;
import com.example.marketboard.exception.NameCheckException;
import com.example.marketboard.exception.SignatureCheckException;
import com.example.marketboard.exception.SignatureMismatchException;
import com.example.marketboard.exception.ZeroDepositException;
import com.example.marketboard.exception.ZeroWithdrawException;
